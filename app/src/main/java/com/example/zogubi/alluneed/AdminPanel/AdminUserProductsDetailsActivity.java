...
public class AdminUserProductsDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_user_products_details);
        ...
        usernameOrder = findViewById(R.id.username_order);
        usernameOrder.setText(userId + " Order");
